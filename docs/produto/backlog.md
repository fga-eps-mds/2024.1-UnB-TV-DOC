...
|-----|---------------------|-------------|-------------|---------| ------------ |
| US01   | Eu, como administrador, quero obter dados de visualizações de vídeos, para analisar o engajamento dos usuários. | EE | $$$ | <3 | 5 |
| US02   | Eu, como administrador, quero obter dados de visualizações por categorias, para entender quais tópicos são mais populares. | EE | $$$ | <3 | 5 |
...
| US04   | Eu, como usuário, quero pesquisar vídeos por título, descrição e categoria, para encontrar conteúdos específicos. | EE | $$$ | <3<3<3 | 8 |
...
| ID  | História de Usuário | Esforço (E) | Negócio ($) | UX (<3) | Story Points |
|-----|---------------------|-------------|-------------|---------| ------------ |
| US11  | Eu, como usuário, quero ver o histórico de vídeos que assisti recentemente, para encontrar facilmente vídeos que vi anteriormente. | EE | $$ | <3<3 | 8 |
| US12  | Eu, como usuário, quero configurar minhas preferências de histórico, para gerenciar meu histórico. | EE | $$ | <3<3 | 8 |
| US18  | Eu, como usuário, quero a opção de pular para o próximo vídeo recomendado, para ter uma experiência contínua de visualização. | E | $ | <3<3 | 5 |
| US19  | Eu, como usuário, quero configurar minhas preferências de reprodução automática, para controlar quando os vídeos recomendados devem ser reproduzidos automaticamente. | E | $ | <3<3 | 5 |
...
| ID  | História de Usuário | Esforço (E) | Negócio ($) | UX (<3) | Story Points |
|-----|---------------------|-------------|-------------|---------| ------------ |
| US05   | Eu, como administrador, quero alterar os cargos de outros usuários por meio da tela de administrador. | EE | $$$ | <3<3<3 | 13 |
